...
let s:cdBack = {'gui': '#111111', 'cterm': s:cterm00, 'cterm256': '233'}
...
let s:cdLightGray = {'gui': '#D6D6D6', 'cterm': s:cterm04, 'cterm256': '07'}
...
call <sid>hi('Function', s:cdBlueGreen, {}, 'none', {})
...
call <sid>hi('Include', s:cdLightGray, {}, 'none', {})
...
call <sid>hi('SpecialChar', s:cdViolet, {}, 'none', {})
